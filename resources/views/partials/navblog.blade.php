<nav id="menu1" class="bar bar--sm bar-1 hidden-xs " style="">
    <div class="container">
        <div class="row">
                ...
                <div class="bar__module">
                    <ul class="menu-horizontal text-left">
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -292.766px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12 dropdown__content dropdown__content--lg" style="left: 0px;">
                                            <div class="pos-absolute col-lg-5 imagebg hidden-sm hidden-xs" data-overlay="4">
                                                <div class="background-image-holder" style="background: url(&quot;img/dropdown-1.jpg&quot;); opacity: 1;">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -361.094px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content col-lg-2 col-md-4" style="left: 361.094px;">
                                            <ul class="menu-vertical">
                                                <li class="dropdown">
                                                    <span class="dropdown__trigger">About</span>
                                                    <div class="dropdown__container" style="left: -387.094px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="dropdown__content col-lg-2" style="left: 387.094px;">
                                                                    <ul class="menu-vertical">
                                                                        <li>
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <div class="dropdown__container" style="left: -387.094px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="dropdown__content col-lg-2 col-md-4" style="left: 387.094px;">
                                                                    <ul class="menu-vertical">
                                                                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -431.016px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content col-lg-2 col-md-4" style="left: 431.016px;">
                                            <ul class="menu-vertical">
                                                <li class="dropdown">
                                                    <span class="dropdown__trigger">Articles</span>
                                                    <div class="dropdown__container" style="left: -457.016px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="dropdown__content col-lg-2 col-md-4" style="left: 457.016px;">
                                                                    <ul class="menu-vertical">
                                                                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -495.703px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content col-lg-2 col-md-4" style="left: 495.703px;">
                                            <ul class="menu-vertical">
                                                <li class="dropdown">
                                                    <span class="dropdown__trigger">Shop Standard</span>
                                                    <div class="dropdown__container" style="left: -521.703px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="dropdown__content col-lg-2 col-md-4" style="left: 521.703px;">
                                                                    <ul class="menu-vertical">
                                                                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -560.234px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content col-lg-2 col-md-4" style="left: 560.234px;">
                                            <ul class="menu-vertical">
                                                <li class="dropdown">
                                                    <span class="dropdown__trigger">Titles Outside</span>
                                                    <div class="dropdown__container" style="left: -586.234px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="dropdown__content col-lg-2 col-md-4" style="left: 586.234px;">
                                                                    <ul class="menu-vertical">
                                                                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -661.563px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content dropdown__content--lg col-lg-8" style="left: 380px;">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -740.406px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12 dropdown__content dropdown__content--lg" style="left: 0px;">
                                            <div class="pos-absolute col-lg-5 imagebg hidden-sm hidden-xs" data-overlay="4">
                                                <div class="background-image-holder" style="background: url(&quot;img/dropdown-2.jpg&quot;); opacity: 1;">
